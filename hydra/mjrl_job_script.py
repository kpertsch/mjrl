...
def train_loop(job_data) -> None:
    ...
    if job_data.algorithm == 'NPG':
        ...
        agent = NPG(e, policy, baseline, normalized_step_size=job_data.rl_step_size,
                    seed=job_data.seed, save_logs=True, job_name=job_data.job_name, **job_data.alg_hyper_params)
        ...
        agent = PPO(e, policy, baseline, save_logs=True, job_name=job_data.job_name, **job_data.alg_hyper_params)
    else:
